...
if (mouseColor == endColor) {
	...
	private void scare() {
		...
		AudioClip sound = JApplet.newAudioClip(getClass().getResource("253534__nanakisan__evil-laugh-9 (1).wav"));
