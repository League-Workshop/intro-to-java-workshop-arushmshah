...
if((robotXLocation == 725 && robotYLocation == 400) || (robotXLocation == 725 && robotYLocation == 450)) {
	JOptionPane.showMessageDialog(null, "Now go to the Parots");
}
		// 8. Give the user subsequent clues at different locations on the image
		// (pirate robot, swamp, parrots, etc.)
if((robotXLocation == 650 && robotYLocation == 150) || (robotXLocation == 625 && robotYLocation == 150)|| (robotXLocation == 600 && robotYLocation == 150)) {
	JOptionPane.showMessageDialog(null, "Now go to the Map");
}
if((robotXLocation == 250 && robotYLocation == 350) || (robotXLocation == 275 && robotYLocation == 350)) {
treasureFound();	
}
