...
public class DragonFight {
	...
	public static void main(String[] args) {
		...
		while (playerHealth > 0 && dragonHealth > 0) { // this line of code keeps the battle going until someone's
			...
			// or a kick
			String input = JOptionPane.showInputDialog("Would you like to yell or kick?");
			...
			playerDamage = randGen.nextInt(20);
...
if (playerHealth<=0) {
	...
	JOptionPane.showMessageDialog(null, "You won, you took home a ton of gold!(:");
}
